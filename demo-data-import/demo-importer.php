 ...
 */
function linkpva_core_import_files()
{
	return array(
		array(
			'import_file_name'           => 'Linkpva-Import',
			...
			'import_notice'              => __('Import process may take 3-5 minutes, please be patient. It\'s really based on your network speed.', 'linkpva-core'),
			'preview_url'                => '#',
...
add_filter('ocdi/import_files', 'linkpva_core_import_files');


// Empty sidebar before import demo data 
function linkpva_before_demo_import()
{
...
add_action('ocdi/before_widgets_import', 'linkpva_before_demo_import');


function linkpva_after_import_setup()
{
	...
	function linkpva_woocommerce_settings()
	{
		$woopages = array(
	...
	function linkpva_update_woocommerce_lookup_table()
	{
	...
	linkpva_woocommerce_settings();
	linkpva_update_woocommerce_lookup_table();
...
add_action('ocdi/after_import', 'linkpva_after_import_setup');
 ...
 */
function linkpva_ocdi_confirmation_dialog_options($options)
{
...
add_filter('ocdi/confirmation_dialog_options', 'linkpva_ocdi_confirmation_dialog_options', 10, 1);

// Disable the branding notice - Linkpva Themes
 ...
 */
function linkpva_plugin_intro_text($default_text)
{
...
add_filter('ocdi/plugin_intro_text', 'linkpva_plugin_intro_text');
