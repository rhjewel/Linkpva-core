...
class Egns_Product_Category_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            __('Egns Product Category', 'linkpva-core'),
            array(
                'description' => __('Displays product categories with custom SVG icon', 'linkpva-core'),
            )
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        function linkpva_product_category_tree($parent_id = 0, $limit = 0)
        {
            $args = array(
            ...
            foreach ($categories as $category) {
                ...
                // Child (no limit)
                linkpva_product_category_tree($category->term_id, 0);
        ...
        // Call with limit
        linkpva_product_category_tree(0, $number_of_categories);
...
?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number_of_categories')); ?>"><?php echo esc_html__('Number of categories to show:', 'linkpva-core'); ?></label>
