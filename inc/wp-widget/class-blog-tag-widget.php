...
class Egns_Blog_Tags_Custom_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            __('Egns Blog Tags (Custom)', 'linkpva-core'),
            array(
                'description' => __('Displays blog tags in custom HTML structure', 'linkpva-core'),
            )
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (!empty($tags)) {
            ...
            echo '<p>' . esc_html__('No tags found.', 'linkpva-core') . '</p>';
        }
