...
class Egns_Product_Tags_Custom_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            __('Egns Product Tags (Custom)', 'linkpva-core'),
            array(
                'description' => __('Displays product tags in custom HTML structure', 'linkpva-core'),
            )
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (!empty($tags) && !is_wp_error($tags)) {
            ...
            echo '<p>' . esc_html__('No product tags found.', 'linkpva-core') . '</p>';
        }
...
?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number_of_tags')); ?>"><?php echo esc_html__('Number of tags to show:', 'linkpva-core'); ?></label>
