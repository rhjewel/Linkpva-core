...
class Egns_Search_Custom_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            'egns_search_custom',
            __('Egns Search', 'linkpva-core'),
            array(
                'description' => __('Displays search in custom HTML structure', 'linkpva-core'),
            )
        );
    }
...
?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php echo esc_html__('Search Label:', 'linkpva-core'); ?></label>
