...
CSF::createSection(
	$quote_prefix,
	array(
		'title'  => esc_html__('Quote Post Setting', 'linkpva-core'),
		'fields' => array(
			array(
				'id'          => 'egns_quote_text',
				'type'        => 'textarea',
				'title'       => esc_html__('Quote Text', 'linkpva-core'),
				'subtitle'    => esc_html__('Paste here a valid quote text which is support auto embed with WordPress for post quote.', 'linkpva-core'),
