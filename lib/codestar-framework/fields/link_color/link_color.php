...
if (! class_exists('CSF_Field_link_color')) {
  class CSF_Field_link_color extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      $color_props = array(
        'color'    => esc_html__('Normal', 'linkpva-core'),
        'hover'    => esc_html__('Hover', 'linkpva-core'),
        'active'   => esc_html__('Active', 'linkpva-core'),
        'visited'  => esc_html__('Visited', 'linkpva-core'),
        'focus'    => esc_html__('Focus', 'linkpva-core')
      );
