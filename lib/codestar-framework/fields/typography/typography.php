  ...
  class CSF_Field_typography extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      if (! empty($args['font_family'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Family', 'linkpva-core') . '</div>';
        echo $this->create_select(array($this->value['font-family'] => $this->value['font-family']), 'font-family', esc_html__('Select a font', 'linkpva-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['backup_font_family'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Backup Font Family', 'linkpva-core') . '</div>';
        echo $this->create_select(apply_filters('csf_field_typography_backup_font_family', array(
          ...
          'Georgia, serif',
          'Palatino Linotype'
        )), 'backup-font-family', esc_html__('Default', 'linkpva-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['font_weight']) || ! empty($args['font_style'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Style', 'linkpva-core') . '</div>';
        echo '<select class="csf--font-style-select" data-placeholder="Default">';
        echo '<option value="">' . (! $this->chosen ? esc_html__('Default', 'linkpva-core') : '') . '</option>';
        ...
        if (! empty($args['extra_styles'])) {
          ...
          echo (! $this->chosen) ? '<div class="csf--title">' . esc_html__('Load Extra Styles', 'linkpva-core') . '</div>' : '';
          $placeholder = ($this->chosen) ? esc_html__('Load Extra Styles', 'linkpva-core') : esc_html__('Default', 'linkpva-core');
      ...
      if (! empty($args['subset'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Subset', 'linkpva-core') . '</div>';
        $subset = (is_array($this->value['subset'])) ? $this->value['subset'] : array_filter((array) $this->value['subset']);
        echo $this->create_select($subset, 'subset', esc_html__('Default', 'linkpva-core'), $args['multi_subset']);
        echo '</div>';
      }
      ...
      if (! empty($args['text_align'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Align', 'linkpva-core') . '</div>';
        echo $this->create_select(array(
          'inherit' => esc_html__('Inherit', 'linkpva-core'),
          'left'    => esc_html__('Left', 'linkpva-core'),
          'center'  => esc_html__('Center', 'linkpva-core'),
          'right'   => esc_html__('Right', 'linkpva-core'),
          'justify' => esc_html__('Justify', 'linkpva-core'),
          'initial' => esc_html__('Initial', 'linkpva-core')
        ), 'text-align', esc_html__('Default', 'linkpva-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['font_variant'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Font Variant', 'linkpva-core') . '</div>';
        echo $this->create_select(array(
          'normal'         => esc_html__('Normal', 'linkpva-core'),
          'small-caps'     => esc_html__('Small Caps', 'linkpva-core'),
          'all-small-caps' => esc_html__('All Small Caps', 'linkpva-core')
        ), 'font-variant', esc_html__('Default', 'linkpva-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['text_transform'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Transform', 'linkpva-core') . '</div>';
        echo $this->create_select(array(
          'none'       => esc_html__('None', 'linkpva-core'),
          'capitalize' => esc_html__('Capitalize', 'linkpva-core'),
          'uppercase'  => esc_html__('Uppercase', 'linkpva-core'),
          'lowercase'  => esc_html__('Lowercase', 'linkpva-core')
        ), 'text-transform', esc_html__('Default', 'linkpva-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['text_decoration'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Decoration', 'linkpva-core') . '</div>';
        echo $this->create_select(array(
          'none'               => esc_html__('None', 'linkpva-core'),
          'underline'          => esc_html__('Solid', 'linkpva-core'),
          'underline double'   => esc_html__('Double', 'linkpva-core'),
          'underline dotted'   => esc_html__('Dotted', 'linkpva-core'),
          'underline dashed'   => esc_html__('Dashed', 'linkpva-core'),
          'underline wavy'     => esc_html__('Wavy', 'linkpva-core'),
          'underline overline' => esc_html__('Overline', 'linkpva-core'),
          'line-through'       => esc_html__('Line-through', 'linkpva-core')
        ), 'text-decoration', esc_html__('Default', 'linkpva-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['font_size'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Font Size', 'linkpva-core') . '</div>';
      ...
      if (! empty($args['line_height'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Line Height', 'linkpva-core') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (! empty($args['letter_spacing'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Letter Spacing', 'linkpva-core') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (! empty($args['word_spacing'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Word Spacing', 'linkpva-core') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (! empty($args['color'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Color', 'linkpva-core') . '</div>';
      ...
      if (! empty($args['custom_style'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Custom Style', 'linkpva-core') . '</div>';
    ...
    public function enqueue()
    {
      ...
      if (! wp_script_is('csf-webfontloader')) {
        ...
        wp_enqueue_script('csf-webfontloader', 'https://cdn.jsdelivr.net/npm/webfontloader@1.6.28/webfontloader.min.js', array('linkpva-core'), '1.6.28', true);
        ...
        if (! empty($customwebfonts)) {
          $webfonts['custom'] = array(
            'label' => esc_html__('Custom Web Fonts', 'linkpva-core'),
            'fonts' => $customwebfonts
          );
        }

        $webfonts['safe'] = array(
          'label' => esc_html__('Safe Web Fonts', 'linkpva-core'),
          'fonts' => apply_filters(
        ...
        $webfonts['google'] = array(
          'label' => esc_html__('Google Web Fonts', 'linkpva-core'),
          'fonts' => apply_filters(
        ...
        wp_localize_script('linkpva-core', 'csf_typography_json', array(
          'webfonts'      => $webfonts,
