  ...
  class CSF_Field_border extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      $args = wp_parse_args($this->field, array(
        ...
        'top_placeholder'    => esc_html__('top', 'linkpva-core'),
        'right_placeholder'  => esc_html__('right', 'linkpva-core'),
        'bottom_placeholder' => esc_html__('bottom', 'linkpva-core'),
        'left_placeholder'   => esc_html__('left', 'linkpva-core'),
        'all_placeholder'    => esc_html__('all', 'linkpva-core'),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__('Solid', 'linkpva-core'),
        'dashed'    => esc_html__('Dashed', 'linkpva-core'),
        'dotted'    => esc_html__('Dotted', 'linkpva-core'),
        'double'    => esc_html__('Double', 'linkpva-core'),
        'inset'     => esc_html__('Inset', 'linkpva-core'),
        'outset'    => esc_html__('Outset', 'linkpva-core'),
        'groove'    => esc_html__('Groove', 'linkpva-core'),
        'ridge'     => esc_html__('ridge', 'linkpva-core'),
